package Box2D.Collision{
	...
	public class b2BroadPhase {
		...
		private function Query(lowerQueryOut:Array, upperQueryOut:Array, lowerValue:uint, upperValue:uint, bounds:Array,
		                       boundCount:uint, axis:int):void {
		...
		b2internal var m_bounds:Array = new Array();
