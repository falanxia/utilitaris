package Box2D.Collision{
	...
	public class b2Collision {
		...
		static public function EdgeSeparation(poly1:b2PolygonShape, xf1:b2XForm, edge1:int, poly2:b2PolygonShape, xf2:b2XForm):Number {
		...
		// from poly1.
		static public function FindMaxSeparation(edgeIndex:Array /*int ptr*/, poly1:b2PolygonShape, xf1:b2XForm, poly2:b2PolygonShape,
		                                         xf2:b2XForm):Number {
			var count1:int = poly1.m_vertexCount;
			var normals1:Array = poly1.m_normals;
		...
		static public function FindIncidentEdge(c:Array, poly1:b2PolygonShape, xf1:b2XForm, edge1:int, poly2:b2PolygonShape,
		                                        xf2:b2XForm):void {
			var count1:int = poly1.m_vertexCount;
			var normals1:Array = poly1.m_normals;
		...
		static public function b2CollidePolygons(manifold:b2Manifold, polyA:b2PolygonShape, xfA:b2XForm, polyB:b2PolygonShape,
		                                         xfB:b2XForm):void {
			var cv:ClipVertex;
		...
		static public function b2CollideCircles(manifold:b2Manifold, circle1:b2CircleShape, xf1:b2XForm, circle2:b2CircleShape,
		                                        xf2:b2XForm):void {
			manifold.pointCount = 0;
		...
		static public function b2CollidePolygonAndCircle(manifold:b2Manifold, polygon:b2PolygonShape, xf1:b2XForm,
